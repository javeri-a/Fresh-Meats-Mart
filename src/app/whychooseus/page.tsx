...
//       <div className="absolute bottom-0 left-0 w-48 h-48 bg-red-50 rounded-full -translate-x-24 translate-y-24"></div>

//       <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
//         {/* Clean Header */}
//         <div className="text-center mb-12">
//           <div className="inline-flex items-center px-4 py-2 rounded-full bg-red-600 text-white text-sm font-semibold mb-6 shadow-lg">
//             <div className="w-2 h-2 bg-white rounded-full mr-2 animate-pulse"></div>
//             ADVANCED TECHNOLOGY
//           </div>
//           <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
//             Scientific Meat <span className="text-red-600">Quality Assurance</span>
//           </h2>
//           <div className="w-16 h-1 bg-red-600 mx-auto mb-4"></div>
//           <p className="text-lg text-gray-600 max-w-2xl mx-auto">
//             30 years of tradition meets cutting-edge food safety technology
//           </p>
//         </div>
...
//             <div key={index} className="group text-center p-6 rounded-xl bg-white border border-red-100 hover:border-red-300 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/10">
//               <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-red-100 text-red-600 flex items-center justify-center group-hover:bg-red-600 group-hover:text-white transition-all duration-300">
//                 {feature.icon}
//               </div>
...
//           <button className="inline-flex items-center px-8 py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition-colors duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
