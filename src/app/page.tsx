  ...
  return (
    <div>
      <section className="bg-gradient-to-b from-red-50 to-white relative overflow-hidden">
        {/* Background Blobs */}
        <div className="absolute inset-0 z-0">
          <div className="absolute top-0 left-0 w-56 h-56 bg-red-100 rounded-full mix-blend-multiply blur-3xl opacity-40 animate-blob"></div>
          <div className="absolute top-0 right-0 w-56 h-56 bg-orange-100 rounded-full mix-blend-multiply blur-3xl opacity-40 animate-blob animation-delay-2000"></div>
          <div className="absolute bottom-0 left-1/2 w-56 h-56 bg-purple-100 rounded-full mix-blend-multiply blur-3xl opacity-40 animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="text-center md:text-left"
            >
              <span className="bg-red-100 text-red-600 px-6 py-2 rounded-full text-sm font-bold inline-flex items-center gap-2 shadow hover:shadow-md transition">
                🚚 Fresh Daily Delivery
                <span className="h-2 w-2 bg-red-500 rounded-full animate-pulse"></span>
              </span>
              ...
              <p className="text-lg md:text-xl text-gray-600 mt-6 mb-8 max-w-xl mx-auto md:mx-0">
                🏆 Award-Winning Butchers • 🧊 Flash-Frozen Freshness • 🚀 Instant Delivery
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <Link
                  href="/order"
                  className="bg-gradient-to-r from-red-600 to-orange-600 text-white px-8 py-4 rounded-xl text-lg font-bold hover:shadow-lg flex items-center gap-3 group"
                >
                  <FiShoppingCart className="w-6 h-6 group-hover:animate-bounce" />
                  Order Now
                </Link>
                <Link
                  href="/contact"
                  className="border-2 border-red-600 text-red-600 px-8 py-4 rounded-xl text-lg font-bold hover:bg-red-50 transition flex items-center gap-3 group"
                >
                  <FiPhoneCall className="w-6 h-6 group-hover:animate-pulse" />
                  Instant Support
                </Link>
              </div>
              ...
              <div className="mt-12 grid grid-cols-3 gap-6">
                {[
                  ...
                  <div
                    key={i}
                    className={`p-4 rounded-xl ${item.color} hover:shadow-md cursor-pointer border border-transparent hover:border-red-200 transition`}
                  >
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.8, type: "spring" }}
              className="relative h-[480px] rounded-3xl overflow-hidden shadow-2xl border-8 border-white group"
            >
              <Image
                src="/hero1.png"
                alt="Premium Meat Selection"
              ...
              {/* Floating Badge */}
              <motion.div
                className="absolute top-6 right-6 bg-white px-5 py-2 rounded-full shadow flex items-center gap-2"
                animate={{ y: [0, -10, 0] }}
                transition={{ duration: 2, repeat: Infinity }}
              >
                <span className="animate-ping absolute inline-flex h-3 w-3 rounded-full bg-green-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-3 w-3 bg-green-500"></span>
                <span className="text-sm font-bold text-gray-800">LIVE INVENTORY</span>
              </motion.div>
            </motion.div>
          </div>
        </div>
      ...
      {/* Tidio Script */}
      <Script src="//code.tidio.co/jnvlar7ejktx0t2rjosp2a5bk1yenbkk.js" strategy="lazyOnload" />
